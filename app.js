...
var UIController = (function () {
    ...
    var formatNumber = function (num, type) {
        ...
        */
        ...
        num = Math.abs(num);
        num = num.toFixed(2); // strings and numbers can have methods (js convert them to objects)
        numSplit = num.split('.'); // split into an array of int and dec

        int = numSplit[0];
        if (int.length > 3) { // only work for 1000s but not 1,000,000s
